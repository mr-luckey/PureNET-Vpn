...
class APIs {
  static Future<List<Vpn>> getVPNServers() async {
    ...
    log('[DEBUG] APIs.getVPNServers: ENTRY - fetching vpngate API');

    try {
      final res = await get(Uri.parse('http://www.vpngate.net/api/iphone/'));
      log('[DEBUG] APIs.getVPNServers: got response status=${res.statusCode}');
      ...
      log('[DEBUG] APIs.getVPNServers: parsed ${vpnList.length} servers');
    } catch (e) {
